  ...
  return (
    <main className="min-h-screen bg-black flex items-center justify-center px-4" style={{ fontFamily: "'Syne', sans-serif" }}>
      <style>{`
        ...
        .btn-primary {
          background: white; color: black; transition: all 0.2s;
...
<div className="flex items-center justify-center mb-10">
        ...
        <div className="card rounded-2xl p-8">
          <h1 className="text-white font-bold text-2xl tracking-tight mb-1">Create account</h1>
          <p className="text-white/25 text-xs font-mono mb-7">Get started with Conversio</p>
